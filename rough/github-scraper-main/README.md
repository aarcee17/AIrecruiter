...
Thirdly we're building this project to [***scratch our own itch***](https://gettingreal.37signals.com/ch02_Whats_Your_Problem.php)... scraping the _pages_ of GitHub has given us a _unique_ insight into the features of the platform which has leveled-up our skills.
...
- **X-RateLimit-Limit**: **60** (can only make 60 requests per hour) ...
  ...
  Not really enough to do any sort of trend analysis. 😞
